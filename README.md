...
​I built a virtual pentesting lab using VirtualBox to test security tools and practice network assessments in a self-contained setup. Setting it up on a private network keeps the traffic isolated while making it easy to plug in more target VMs down the road.
